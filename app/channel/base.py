...
MyClaw 支持多个 IM 平台（飞书 / 企业微信）同时在线。每个平台实现
...
class Channel(Protocol):
    ...
    async def send_view(self, target: UserTarget, kind: str, payload: dict) -> None:
        ...
        claude_dir_setup / workspace_selection / cd_confirm /
        provider_selection / level_selection / effort_selection /
        mode_selection / session_selection / file_selection / help /
        balance / reuse_last / ws_config_reuse
        """
        ...
