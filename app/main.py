...
async def lifespan(app: FastAPI):
    ...
    logger.info("myclaw starting... (channels: %s)", ",".join(enabled) or "(none)")
    ...
    if "feishu" in enabled:
        ...
        logger.info("Feishu channel disabled (no credentials or MYCLAW_CHANNELS override)")
    ...
    # Profiles are selected per user and persisted outside Claude sessions.
